...
ACUs come from the consumption API, summed over the session and any children it delegated
to, because a session payload reports `acus_consumed: 0.0` even for work that was billed and
a delegating parent is billed nothing. The organization scope
